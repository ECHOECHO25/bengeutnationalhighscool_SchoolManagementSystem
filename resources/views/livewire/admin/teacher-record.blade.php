<div>
    ...
    <x-filament::modal id="import-teacher" width="xl">
        <x-slot name="heading">
            <h1 class="font-semibold text-gray-700 text-xl">Import Teacher Records</h1>
        </x-slot>
        ...
        <x-slot name="footer">
            <x-filament::button wire:click="importTeacher" color="primary">
                Import Now
            </x-filament::button>
        </x-slot>
    </x-filament::modal>
